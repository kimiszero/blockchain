...
//수정해주세요 
contract DinoCoin is StandardToken { // CHANGE THIS. Update the contract name.
...
//수정해주세요
    function DinoCoin() {
        ...
        name = "DinoCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DINO";                                             // Set the symbol for display purposes (CHANGE THIS)
